//To display the maximum range of Globetrotter with current energy
...
async function Rem() {
    ...
    if (xd[1].checked) {
        swal("Finding Globetrotter Range is practically not possible in Multiple Destinations Case ")
        return;
    }
    ...
    if (elem.value == "Globetrotter")
        elem.value = "Clear";
    else {
        elem.value = "Globetrotter";
    ...
    while (!que.isEmpty()) {
        ...
        if (p.dist > (2 * new_energy - 1)) continue;
        else {
