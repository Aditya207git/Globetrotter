...
//Notification of Low Energy
function energy_low() {
    swal({
        title: "Sorry!!",
        text: "Energy is too Low. Reenrgize first!!",
        icon: "error",
        button: "OK",
    });
}
...
//Animate the current level of energy 
function display_energy() {
    var ii = 0;
    if (ii == 0) {
        ii = 1;
        var elem = document.getElementById("myBar");
        var width = old_energy;
